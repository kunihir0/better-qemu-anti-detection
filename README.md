...
cd qemu-8.2.2
git apply ../better-qemu-anti-detection/qemu-8.2.0.patch
git apply ../better-qemu-anti-detection/qemu-8.2.0-libnfs6.patch
git apply ../better-qemu-anti-detection/qemu-8.2.0-sysc.patch
./configure
